...
if __name__ == "__main__":
    path = "/data3/cxx/LJ/nocs_viz/scene_05000101/0000.png"
    img = cv2.imread(path)
    pred_size = np.array([0.28449425, 0.2123641 , 0.33901024])
    RT = np.array([[-0.92758656,  0.17550871,  0.32530004, 0.02613904],
                   [-0.01277715,  0.86103237, -0.5075247, -0.06450552 ],
                   [ 0.37338975,  0.47730488,  0.79787123, 0.4757929],
                   [0, 0, 0, 1]])
